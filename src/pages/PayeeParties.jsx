...
function PayeeParties() {
  ...
  const getData = async () => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_APP_SERVER}/api/sims/get-payee`,
        {
          method: 'GET',
  ...
  const handleAddParty = async () => {
    ...
    try {
      setLoading(true);
      const response = await fetch(
        `${import.meta.env.VITE_APP_SERVER}/api/sims/add-payee`,
        {
          method: 'POST',
          headers: {
    ...
    <Box sx={{ p: { xs: 2, md: 3 } }}>
      ...
      >
        <Typography variant='h5' fontWeight={600}>
          List of <span className='text-blue-400'>Payee / BS Bank</span> Parties
        </Typography>
        ...
        <DialogContent>
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, mt: 1 }}>
            <TextField
              ...
              onChange={(e) =>
                setNewParty({ ...newParty, displayName: e.target.value })
              }
              fullWidth
            />
            <TextField
            ...
            <TextField
              ...
              onChange={(e) =>
                setNewParty({ ...newParty, middleName: e.target.value })
              }
              fullWidth
            />
            <TextField
            ...
            <TextField
              ...
              onChange={(e) =>
                setNewParty({ ...newParty, idType: e.target.value })
              }
              fullWidth
            >
            ...
            <TextField
              ...
              onChange={(e) =>
                setNewParty({ ...newParty, idValue: e.target.value })
              }
              type='number'
              fullWidth
            />
